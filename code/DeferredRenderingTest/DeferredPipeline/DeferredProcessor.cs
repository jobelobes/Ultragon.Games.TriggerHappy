...
{
    /// </summary>
    [ContentProcessor(DisplayName = "Deferred Content Processor")]
    public class DeferredModelProcessor : ModelProcessor
    {
                                                                                ...
                                                                                ContentProcessorContext context)
        {
            ...
            deferredShadingMaterial.Effect = new ExternalReference<EffectContent>("DeferredGBuffer.fx");
        ...
        {
            get { return this.normalMapTexture; }
            set { this.normalMapTexture = value; }
        }
