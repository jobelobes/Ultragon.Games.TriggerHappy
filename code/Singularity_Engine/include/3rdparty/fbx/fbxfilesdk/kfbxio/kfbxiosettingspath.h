...
#define IOSN_MASTER_FRAME_RATE_STR       "MasterFrameRateStr"
...
#define IMP_MASTERUNITSTR               IMP_UNITS_GRP"|"IOSN_MASTERUNITSTR
...
#define IMP_MASTER_FRAME_RATE_STR       IMP_CURVEFILTERS"|"IOSN_MASTER_FRAME_RATE_STR
