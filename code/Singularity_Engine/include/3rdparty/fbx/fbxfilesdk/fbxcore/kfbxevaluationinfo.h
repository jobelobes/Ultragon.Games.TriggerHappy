/*!  \file kfbxevaluationinfo.h
 */

#ifndef FBXFILESDK_FBXCORE_KFBXEVALUATIONINFO_H
#define FBXFILESDK_FBXCORE_KFBXEVALUATIONINFO_H
...
#endif // FBXFILESDK_FBXCORE_KFBXEVALUATIONINFO_H
