...
/** This class organizes selection object and its components together.
* \nosubgrouping
*  SelectionNode is an auxiliary class for Selection Set. 
*  It is used to add components (vertex, edge and face) of an object to a selection set.
*  The object and its different components can be organized into one selection node,
*  and then add to selection set in one time.
*/
