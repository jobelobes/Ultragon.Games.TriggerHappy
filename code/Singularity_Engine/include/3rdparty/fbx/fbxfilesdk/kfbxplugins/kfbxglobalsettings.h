...
public:
	/** Assignment operator.
	  * \param pGlobalSettings KFbxGlobalSettings object copied to this one.
	  */
    ...
    * \return     The original UpAxis of coordinate system when the scene is created. 0 is X, 1 is Y, 2 is Z axis.
    */
