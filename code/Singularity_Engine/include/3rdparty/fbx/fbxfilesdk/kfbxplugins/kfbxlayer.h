...
/** \brief KFbxLayerElement is the base class for Layer Elements. 
  * It describes how a Layer Element is mapped to a geometry surface and how the 
...
/** \brief Identifies what error occurs when the data arrays are manipulated.
  * \nosubgrouping
  */
...
public:
    ...
    */
	...
	/** Grants a locked access to the data buffer. 
	  ...
	  * \remark                          In the case of a failure, the Status is updated with the
	...
	/** Unlock the data buffer.
	  ...
	  * \remark The passed pointer must be the one obtained by the call to GetLocked().
    ...
    /** Returns the specified item's value.  
      ...
      * \remark                     If the index is invalid, pItem is set to zero.
      */
...
public:
	...
	/** Removes all elements from the direct and the index arrays.
	  * \remark This function fails if there is a lock on the arrays.
...
/** \brief KFbxLayer class provides a base for the layering mechanism.
  * 
...
public:
	...
	/** Returns the EmissiveUV description for this layer.
	  ...
	  * \return     Pointer to the EmissiveUV layer element, or \c NULL if no EmissiveUV are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementUV const* GetEmissiveUV() const;
	...
	/** Get the EmissiveFactorUV description for this layer.
	  ...
	  * \return     Pointer to the EmissiveFactorUV layer element, or \c NULL if no EmissiveFactorUV are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementUV const* GetEmissiveFactorUV() const;
	...
	/** Get the AmbientUV description for this layer.
	  ...
	  * \return     Pointer to the AmbientUV layer element, or \c NULL if no AmbientUV are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementUV const* GetAmbientUV() const;
	...
	/** Get the AmbientFactorUV description for this layer.
	  ...
	  * \return     Pointer to the AmbientFactorUV layer element, or \c NULL if no AmbientFactorUV are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementUV const* GetAmbientFactorUV() const;
	...
	/** Get the DiffuseUV description for this layer.
	  ...
	  * \return     Pointer to the DiffuseUV layer element, or \c NULL if no DiffuseUV are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementUV const* GetDiffuseUV() const;
	...
	/** Get the DiffuseFactorUV description for this layer.
	  ...
	  * \return     Pointer to the DiffuseFactorUV layer element, or \c NULL if no DiffuseFactorUV are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementUV const* GetDiffuseFactorUV() const;
	...
	/** Get the SpecularUV description for this layer.
	  ...
	  * \return     Pointer to the SpecularUV layer element, or \c NULL if no SpecularUV are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementUV const* GetSpecularUV() const;
	...
	/** Get the SpecularFactorUV description for this layer.
	  ...
	  * \return     Pointer to the SpecularFactorUV layer element, or \c NULL if no SpecularFactorUV are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementUV const* GetSpecularFactorUV() const;
	...
	/** Get the ShininessUV description for this layer.
	  ...
	  * \return     Pointer to the ShininessUV layer element, or \c NULL if no ShininessUV are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementUV const* GetShininessUV() const;
	...
	/** Get the NormalMapUV description for this layer.
	  ...
	  * \return     Pointer to the BumpUV layer element, or \c NULL if no BumpUV are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementUV const* GetNormalMapUV() const;
	...
	/** Get the BumpUV description for this layer.
	  ...
	  * \return     Pointer to the BumpUV layer element, or \c NULL if no BumpUV are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementUV const* GetBumpUV() const;
	...
	/** Get the TransparentUV description for this layer.
	  ...
	  * \return     Pointer to the TransparentUV layer element, or \c NULL if no TransparentUV are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementUV const* GetTransparentUV() const;
	...
	/** Get the TransparencyFactorUV description for this layer.
	  ...
	  * \return     Pointer to the TransparencyFactorUV layer element, or \c NULL if no TransparencyFactorUV are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementUV const* GetTransparencyFactorUV() const;
	...
	/** Get the ReflectionUV description for this layer.
	  ...
	  * \return     Pointer to the ReflectionUV layer element, or \c NULL if no ReflectionUV are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementUV const* GetReflectionUV() const;
	...
	/** Get the ReflectionFactorUV description for this layer.
	  ...
	  * \return     Pointer to the ReflectionFactorUV layer element, or \c NULL if no ReflectionFactorUV are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementUV const* GetReflectionFactorUV() const;

    /** Get the DisplacementUV description for this layer.
      * This function is deprecated and has been replaced by GetUVs(KFbxLayerElement::ELayerElementType pTypeIdentifier)
	  * \return     Pointer to the DisplacementUV layer element, or \c NULL if no DisplacementUV are defined for this layer.
	  */
	...
	/** Get the DisplacementUV description for this layer.
	  ...
	  * \return     Pointer to the DisplacementUV layer element, or \c NULL if no DisplacementUV are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementUV const* GetDisplacementUV() const;
    ...
    */
    ...
    /** Returns the EmissiveTextures description for this layer.
	  ...
	  */
	K_DEPRECATED KFbxLayerElementTexture* GetEmissiveTextures();

	/** Returns the EmissiveTextures description for this layer.
      * This function is deprecated and has been replaced by GetTextures(KFbxLayerElement::ELayerElementType pType)
	  * \return     Pointer to the EmissiveTextures layer element, or \c NULL if no EmissiveTextures are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementTexture const* GetEmissiveTextures() const;
    ...
    /** Returns the EmissiveFactorTextures description for this layer.
	  ...
	  */
	K_DEPRECATED KFbxLayerElementTexture* GetEmissiveFactorTextures();

	/** Returns the EmissiveFactorTextures description for this layer.
      * This function is deprecated and has been replaced by GetTextures(KFbxLayerElement::ELayerElementType pType)
	  * \return     Pointer to the EmissiveFactorTextures layer element, or \c NULL if no EmissiveFactorTextures are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementTexture const* GetEmissiveFactorTextures() const;
    ...
    /** Returns the AmbientTextures description for this layer.
	  ...
	  */
	K_DEPRECATED KFbxLayerElementTexture* GetAmbientTextures();

	/** Returns the AmbientTextures description for this layer.
      * This function is deprecated and has been replaced by GetTextures(KFbxLayerElement::ELayerElementType pType)
	  * \return     Pointer to the AmbientTextures layer element, or \c NULL if no AmbientTextures are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementTexture const* GetAmbientTextures() const;
    ...
    /** Returns the AmbientFactorTextures description for this layer.
	  ...
	  */
	K_DEPRECATED KFbxLayerElementTexture* GetAmbientFactorTextures();

	/** Returns the AmbientFactorTextures description for this layer.
      * This function is deprecated and has been replaced by GetTextures(KFbxLayerElement::ELayerElementType pType)
	  * \return     Pointer to the AmbientFactorTextures layer element, or \c NULL if no AmbientFactorTextures are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementTexture const* GetAmbientFactorTextures() const;
     ...
     * \return     Pointer to the DiffuseTextures layer element, or \c NULL if no DiffuseTextures are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementTexture* GetDiffuseTextures();

	/** Get the DiffuseTextures description for this layer.
      * This function is deprecated and has been replaced by GetTextures(KFbxLayerElement::ELayerElementType pType)
	  * \return     Pointer to the DiffuseTextures layer element, or \c NULL if no DiffuseTextures are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementTexture const* GetDiffuseTextures() const;
    ...
    /** Get the DiffuseFactorTextures description for this layer.
	  ...
	  */
	K_DEPRECATED KFbxLayerElementTexture* GetDiffuseFactorTextures();

	/** Get the DiffuseFactorTextures description for this layer.
      * This function is deprecated and has been replaced by GetTextures(KFbxLayerElement::ELayerElementType pType)
	  * \return     Pointer to the DiffuseFactorTextures layer element, or \c NULL if no DiffuseFactorTextures are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementTexture const* GetDiffuseFactorTextures() const;
    ...
    /** Get the SpecularTextures description for this layer.
	  ...
	  */
	K_DEPRECATED KFbxLayerElementTexture* GetSpecularTextures();

	/** Get the SpecularTextures description for this layer.
      * This function is deprecated and has been replaced by GetTextures(KFbxLayerElement::ELayerElementType pType)
	  * \return     Pointer to the SpecularTextures layer element, or \c NULL if no SpecularTextures are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementTexture const* GetSpecularTextures() const;
    ...
    /** Get the SpecularFactorTextures description for this layer.
	  ...
	  */
	K_DEPRECATED KFbxLayerElementTexture* GetSpecularFactorTextures();

	/** Get the SpecularFactorTextures description for this layer.
      * This function is deprecated and has been replaced by GetTextures(KFbxLayerElement::ELayerElementType pType)
	  * \return     Pointer to the SpecularFactorTextures layer element, or \c NULL if no SpecularFactorTextures are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementTexture const* GetSpecularFactorTextures() const;
    ...
    /** Get the ShininessTextures description for this layer.
	  ...
	  */
	K_DEPRECATED KFbxLayerElementTexture* GetShininessTextures();

	/** Get the ShininessTextures description for this layer.
      * This function is deprecated and has been replaced by GetTextures(KFbxLayerElement::ELayerElementType pType)
	  * \return     Pointer to the ShininessTextures layer element, or \c NULL if no ShininessTextures are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementTexture const* GetShininessTextures() const;
	...
	/** Get the NormalMapTextures description for this layer.
	  ...
	  */
	K_DEPRECATED KFbxLayerElementTexture* GetNormalMapTextures();

	/** Get the NormalMapTextures description for this layer.
      * This function is deprecated and has been replaced by GetTextures(KFbxLayerElement::ELayerElementType pType)
	  * \return     Pointer to the BumpTextures layer element, or \c NULL if no BumpTextures are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementTexture const* GetNormalMapTextures() const;

    /** Get the BumpTextures description for this layer.
      * This function is deprecated and has been replaced by GetTextures(KFbxLayerElement::ELayerElementType pType)
	  * \return     Pointer to the BumpTextures layer element, or \c NULL if no BumpTextures are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementTexture* GetBumpTextures();

	/** Get the BumpTextures description for this layer.
      * This function is deprecated and has been replaced by GetTextures(KFbxLayerElement::ELayerElementType pType)
	  * \return     Pointer to the BumpTextures layer element, or \c NULL if no BumpTextures are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementTexture const* GetBumpTextures() const;
    ...
    /** Get the TransparentTextures description for this layer.
	  ...
	  */
	K_DEPRECATED KFbxLayerElementTexture* GetTransparentTextures();

	/** Get the TransparentTextures description for this layer.
      * This function is deprecated and has been replaced by GetTextures(KFbxLayerElement::ELayerElementType pType)
	  * \return     Pointer to the TransparentTextures layer element, or \c NULL if no TransparentTextures are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementTexture const* GetTransparentTextures() const;
    ...
    /** Get the TransparencyFactorTextures description for this layer.
	  ...
	  */
	K_DEPRECATED KFbxLayerElementTexture* GetTransparencyFactorTextures();

	/** Get the TransparencyFactorTextures description for this layer.
      * This function is deprecated and has been replaced by GetTextures(KFbxLayerElement::ELayerElementType pType)
	  * \return     Pointer to the TransparencyFactorTextures layer element, or \c NULL if no TransparencyFactorTextures are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementTexture const* GetTransparencyFactorTextures() const;
    ...
    /** Get the ReflectionTextures description for this layer.
	  ...
	  */
	K_DEPRECATED KFbxLayerElementTexture* GetReflectionTextures();

	/** Get the ReflectionTextures description for this layer.
      * This function is deprecated and has been replaced by GetTextures(KFbxLayerElement::ELayerElementType pType)
	  * \return     Pointer to the ReflectionTextures layer element, or \c NULL if no ReflectionTextures are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementTexture const* GetReflectionTextures() const;
    ...
    /** Get the ReflectionFactorTextures description for this layer.
	  ...
	  */
	K_DEPRECATED KFbxLayerElementTexture* GetReflectionFactorTextures();

	/** Get the ReflectionFactorTextures description for this layer.
      * This function is deprecated and has been replaced by GetTextures(KFbxLayerElement::ELayerElementType pType)
	  * \return     Pointer to the ReflectionFactorTextures layer element, or \c NULL if no ReflectionFactorTextures are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementTexture const* GetReflectionFactorTextures() const;

    /** Get the DisplacementTextures description for this layer.
      * This function is deprecated and has been replaced by GetTextures(KFbxLayerElement::ELayerElementType pType)
	  * \return     Pointer to the DisplacementTextures layer element, or \c NULL if no DisplacementTextures are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementTexture* GetDisplacementTextures();

	/** Get the DisplacementTextures description for this layer.
      * This function is deprecated and has been replaced by GetTextures(KFbxLayerElement::ELayerElementType pType)
	  * \return     Pointer to the DisplacementTextures layer element, or \c NULL if no DisplacementTextures are defined for this layer.
	  */
	K_DEPRECATED KFbxLayerElementTexture const* GetDisplacementTextures() const;
...
//handy define for looping through layer elements, get layer element type by index, get index by layer element type
