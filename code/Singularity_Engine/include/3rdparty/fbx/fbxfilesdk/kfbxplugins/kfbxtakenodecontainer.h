...
#ifndef FBXFILESDK_KFBXPLUGINS_KFBXTAKENODECONTAINER_H
#define FBXFILESDK_KFBXPLUGINS_KFBXTAKENODECONTAINER_H
	...
	class KFBX_DLL KFbxTakeNodeContainer : public KFbxObject
	{
		...
		public:
			...
			/**	GetDefaultTakeNode.
			  ...
			  * In this case, KFbxNode::GetCurrentTakeNode() and KFbxNode::GetDefaultTakeNode return
			  * the same pointer.
			  */
		...
		private:
			...
			KFbxTakeNode* GetTakeNode(int pIndex, bool dummy) const;
            // code will be dropped soon.
...
#endif // FBXFILESDK_KFBXPLUGINS_KFBXTAKENODECONTAINER_H
