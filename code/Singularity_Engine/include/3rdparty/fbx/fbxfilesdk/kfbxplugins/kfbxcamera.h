...
public:
    ...
    /**
	  ...
	  * therefore it is the responsability of the client application to process the information in a 
    ...
    /** Get the current state of the flag.
      * \return            \c true if show back plate is enabled, otherwise \c false.
      * \remarks           It is the responsibility of the client application to perform the required tasks according to the state
      *                    of this flag.
      */
    ...
    /** Set the back plane distance from the camera. The the absolute position of the plane must be calculated
	  * by taking into consideration the BackPlaneDistanceMode.
      * \param pDistance    The back plane distance value.
	  * \remarks			It it the responsability of the client application to ensure that this plane position is 
	  *                     within the frustum boundaries.
      */
    void SetBackPlaneDistance(double pDistance);

    /** Get the back plane distance value.
      * \return             The back plane distance value.
      */
    ...
    */
    ...
    /** This property handles the back plane offset
      *
      * To access this property do: BackPlaneOffset.Get()
      * To set this property do: BackPlaneOffset.Set(fbxDouble2).
      *
      * Default value is (0., 0.).
      */
    ...
    /** This property handles the back plane scaling
      *
      * To access this property do: BackPlaneOffset.Get()
      * To set this property do: BackPlaneScale.Set(fbxDouble2).
      *
    ...
    */
    ...
    KFbxTypedProperty<fbxBool1> ShowFrontplate;
      ...
      *
      * To access this property do: FrontPlaneOffset.Get()
      * To set this property do: FrontPlaneOffset.Set(fbxDouble2).
      *
      * Default value is (0., 0.).
      */
    ...
    /** This property handles the front plane scaling.
      *
      * To access this property do: FrontPlaneOffset.Get()
      * To set this property do: FrontPlaneScale.Set(fbxDouble3).
      *
      * Default value is (1., 1.).
      */
