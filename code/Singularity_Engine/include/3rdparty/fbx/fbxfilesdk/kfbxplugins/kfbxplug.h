...
/** \brief Base To define the ClassId of an object
  * \remarks This class Id helps the FBX SDK identify the class hierarchy of plugs and objects. Each Plug is identified by a class id and a parent classId
  * \nosubgrouping
  */
...
public:
	...
	/** Set object type prefix.
	  * \param pObjectTypePrefix object type prefix.
	  */
...
/** \brief Base class to handle plug connections.
...
public:
	...
	/** Test if the class is a hierarchical children of the specified class type  
	  ...
	  * \return Returns true if the object is a hierarchical children of the type specified
	  */
	virtual bool					Is(kFbxClassId pClassId) const			{ return GetClassId().Is(pClassId);	}

	/** Test if the class is a hierarchical children of the specified class type  
	  * \param pFBX_TYPE the class type 
	  * \return Returns true if the object is a hierarchical children of the type specified
	  */
	...
	/** Test if the runtime class is a hierarchical children of the specified class type  
	  * \param pClassId ClassId representing the class type 
	  * \return \c True if the runtime class is a hierarchical children of the type specified, \c false otherwise.
	  */
