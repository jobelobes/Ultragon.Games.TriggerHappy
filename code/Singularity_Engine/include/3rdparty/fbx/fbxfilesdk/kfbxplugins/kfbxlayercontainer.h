...
/** \brief KFbxLayerContainer is the base class for managing Layers. 
  ...
  * A Layer contains the following types of Layer Element(s): 
  *      \li Normals
  *      \li Binormals
  *      \li Tangents
  *      \li Materials
...
public:
	...
	/** Returns the pIndex'th layer that contains the specified layer element type.
	  *	\param pIndex     Layer index.
	  * \param pType      The specified layer element type.
	...
	/**	Returns the global index of the pIndex'th layer that contains the specified layer element type.
	  * \param pIndex     Layer index of the specified type.
	  * \param pType      The specified layer element type.
      * \param pIsUV      When \c true, requests the UV layer element that corresponds with the specified texture type.
	  * \return           Global index of the pIndex'th layer that contains the specified layer element type, or -1 if the layer is not found.
