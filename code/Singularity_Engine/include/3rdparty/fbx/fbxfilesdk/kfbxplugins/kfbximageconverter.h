...
#ifndef FBXFILESDK_KFBXPLUGINS_KFBXIMAGECONVERTER_H
#define FBXFILESDK_KFBXPLUGINS_KFBXIMAGECONVERTER_H
...
{
private:
	int     mWidth;			// number of horizontal pixels
	int     mHeight;		// number of vertical pixels
...
KFBX_DLL bool IsTif(KString pFile);
...
#endif // FBXFILESDK_KFBXPLUGINS_KFBXIMAGECONVERTER_H
