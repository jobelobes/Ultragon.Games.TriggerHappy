...
class KFBX_DLL KFbxLibrary : public KFbxDocument
{
    ...
    public:
        ...
        */
         ...
         * be on a read-only transport).  If this document hasn't been committed yet, then
         ...
         *
         * When transferring an object, all its dependents come with it.  If you move
         * a material, it WILL grab its textures.  Just not the other way around.
		 * \param pSrcLibrary The source library.
         *
         **/
        ...
        /** Return a new instance of a member of the library.
          ...
          * \param pRecurse Check sub-libraries
    ...
    // =======================================================================
        ...
        /** Adds a shading node
		  * \param pShadingObject The shading node to be added.
		  */
        bool AddShadingObject(KFbxObject* pShadingObject);

        /** Removes a shading node
		  * \param pShadingObject The shading node to be removed.
		  */
        ...
        /** Shading node accessor
		  * \param pIndex Shading node index. 
		  * \return The (pIndex)th shading node.
		  */
