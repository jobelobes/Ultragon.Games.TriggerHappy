...
#ifndef FBXFILESDK_COMPONENTS_KBASELIB_KLIB_T_STR_IRIX_H
#define FBXFILESDK_COMPONENTS_KBASELIB_KLIB_T_STR_IRIX_H
...
#include <fbxfilesdk/components/kbaselib/klib/kdebug.h>
    ...
    #error "No UNICODE support is provided for IRIX at this time"
    ...
    #define t_fullpath  fullpath
    #define t_splitpath splitpath
    #define t_makepath  makepath
    #define t_access    access
    #define t_mkdir     mkdir
    #define t_spawnv    spawnv
    #define t_strlwr    cslwr

#endif // K_UNICODE

#endif // FBXFILESDK_COMPONENTS_KBASELIB_KLIB_T_STR_IRIX_H
