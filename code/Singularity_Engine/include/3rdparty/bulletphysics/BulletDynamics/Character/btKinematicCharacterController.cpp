...
btKinematicCharacterController::btKinematicCharacterController (btPairCachingGhostObject* ghostObject,btConvexShape* convexShape,btScalar stepHeight, btMotionState* state, int upAxis)
{
	m_upAxis = upAxis;
	m_addedMargin = 0.02f;
...
bool btKinematicCharacterController::recoverFromPenetration ( btCollisionWorld* collisionWorld)
{
	...
	m_motionState->setWorldTransform(newTrans);
