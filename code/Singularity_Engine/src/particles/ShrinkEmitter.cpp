...
namespace Singularity
{
	namespace Particles
	{
		IMPLEMENT_OBJECT_TYPE(Singularity.Particles, ShrinkEmitter, Renderer);

		#pragma region Event Methods
		void ShrinkEmitter::OnComponentAdded()
		{
		...
		void ShrinkEmitter::OnComponentRemoved()
		{
			this->m_kTimer->Stop();
			RenderTask::Instantiate()->UnregisterRenderer(this);
		}

		void ShrinkEmitter::OnRender(IDeviceContext* context, Camera* camera)
		{
		...
		void ShrinkEmitter::InitializeParticles()
		{
