...
namespace Singularity
{
	namespace Particles
	{
		IMPLEMENT_OBJECT_TYPE(Singularity.Particles, IllusionEmitter, Renderer);

		#pragma region Event Methods
		void IllusionEmitter::OnComponentAdded()
		{
		...
		void IllusionEmitter::OnComponentRemoved()
		{
			this->m_kTimer->Stop();
			RenderTask::Instantiate()->UnregisterRenderer(this);
		}

		void IllusionEmitter::OnRender(IDeviceContext* context, Camera* camera)
		{
		...
		void IllusionEmitter::InitializeParticles()
		{
