...
namespace Singularity
{
	namespace Particles
	{
		IMPLEMENT_OBJECT_TYPE(Singularity.Particles, IncreaseGravityEmitter, Renderer);

		#pragma region Event Methods
		void IncreaseGravityEmitter::OnComponentAdded()
		{
		...
		void IncreaseGravityEmitter::OnComponentRemoved()
		{
			this->m_kTimer->Stop();
			RenderTask::Instantiate()->UnregisterRenderer(this);
		}

		void IncreaseGravityEmitter::OnRender(IDeviceContext* context, Camera* camera)
		{
		...
		void IncreaseGravityEmitter::InitializeParticles()
		{
		...
		void IncreaseGravityEmitter::Start()
		{
		...
		void IncreaseGravityEmitter::Reset()
		{
			this->m_kTimer->Reset();
		}
		#pragma endregion
