...
namespace Singularity
{
	namespace Particles
	{
		IMPLEMENT_OBJECT_TYPE(Singularity.Particles, KnockbackEmitter, Renderer);

		#pragma region Event Methods
		void KnockbackEmitter::OnComponentAdded()
		{
		...
		void KnockbackEmitter::OnComponentRemoved()
		{
			this->m_kTimer->Stop();
			RenderTask::Instantiate()->UnregisterRenderer(this);
		}

		void KnockbackEmitter::OnRender(IDeviceContext* context, Camera* camera)
		{
		...
		void KnockbackEmitter::InitializeParticles()
		{
