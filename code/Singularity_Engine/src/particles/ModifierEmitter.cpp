...
namespace Singularity
{
	namespace Particles
	{
		IMPLEMENT_OBJECT_TYPE(Singularity.Particles, ModifierEmitter, Renderer);

		#pragma region Event Methods
		void ModifierEmitter::OnComponentAdded()
		{
		...
		void ModifierEmitter::OnComponentRemoved()
		{
			this->m_kTimer->Stop();
			RenderTask::Instantiate()->UnregisterRenderer(this);
		}

		void ModifierEmitter::OnRender(IDeviceContext* context, Camera* camera)
		{
		...
		void ModifierEmitter::InitializeParticles()
		{
