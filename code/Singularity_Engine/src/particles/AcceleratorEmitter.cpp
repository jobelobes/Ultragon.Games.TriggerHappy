...
namespace Singularity
{
	namespace Particles
	{
		IMPLEMENT_OBJECT_TYPE(Singularity.Particles, AcceleratorEmitter, Renderer);

		#pragma region Event Methods
		void AcceleratorEmitter::OnComponentAdded()
		{
		...
		void AcceleratorEmitter::OnComponentRemoved()
		{
			this->m_kTimer->Stop();
			RenderTask::Instantiate()->UnregisterRenderer(this);
		}

		void AcceleratorEmitter::OnRender(IDeviceContext* context, Camera* camera)
		{
		...
		void AcceleratorEmitter::InitializeParticles()
		{
