...
namespace Singularity
{
	namespace Particles
	{
		IMPLEMENT_OBJECT_TYPE(Singularity.Particles, InverseGravityEmitter, Renderer);

		#pragma region Event Methods
		void InverseGravityEmitter::OnComponentAdded()
		{
		...
		void InverseGravityEmitter::OnComponentRemoved()
		{
			this->m_kTimer->Stop();
			RenderTask::Instantiate()->UnregisterRenderer(this);
		}

		void InverseGravityEmitter::OnRender(IDeviceContext* context, Camera* camera)
		{
		...
		void InverseGravityEmitter::InitializeParticles()
		{
		...
		void InverseGravityEmitter::Start()
		{
		...
		void InverseGravityEmitter::Reset()
		{
			this->m_kTimer->Reset();
		}
		#pragma endregion
