 ...
 */
	...
	DIM_LEFT_BUTTON =	0x00,
	DIM_RIGHT_BUTTON =	0x01,
	DIM_MIDDLE_BUTTON =	0x02,
	DIM_SIDE_BUTTON =	0x03,
	DIM_SCROLL_WHEEL =	0x04,

};
input = {
	playstate =	{
		forward = digitalKeys.DIK_W,
		backward = digitalKeys.DIK_S,
		turnleft = digitalKeys.DIK_A,
		turnright = digitalKeys.DIK_D,
	}	
}
